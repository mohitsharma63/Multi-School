...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/dashboard/switch-branch', 'HomeController@switchBranch')->name('dashboard.switch-branch');
...
Route::post('get_lga', 'AjaxController@get_lga');
    Route::post('get_class_sections', 'AjaxController@get_class_sections');
    Route::post('get_subjects', 'AjaxController@get_subjects');

Route::post('get_lga', 'AjaxController@get_lga');
    Route::post('get_branches', 'AjaxController@get_branches');
    Route::post('get_class_sections', 'AjaxController@get_class_sections');
    Route::post('get_subjects', 'AjaxController@get_subjects');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'ajax'], function() {
        Route::get('get_lga/{state_id}', 'AjaxController@get_lga')->name('get_lga');
        Route::post('get_branches', 'AjaxController@get_branches')->name('get_branches');
        Route::get('get_class_sections/{class_id}', 'AjaxController@get_class_sections')->name('get_class_sections');
        Route::get('get_class_subjects/{class_id}', 'AjaxController@get_class_subjects')->name('get_class_subjects');
    });
